...
from .constants import CIRCUITOS_DISPONIBLES, CIRCUITOS_DISPONIBLES_LISTA, REGLAS_CLASIFICACION
from .services import FileGenerator, procesar_estructura_completo, ClasificadorEstructuras
        ...
        with transaction.atomic():
            ...
            if not campos_pendientes:
                ...
                try:
                    ...
                    return JsonResponse({
                        'success': False,
                        'error': f'Error generando archivos: {str(e)}'
                    }, status=500)
            else:
